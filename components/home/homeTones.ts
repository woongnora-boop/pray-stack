...
> = {
  amber: {
    ...
    link: 'text-amber-700 [@media(hover:hover)]:hover:bg-amber-500/10 active:bg-amber-500/10 dark:text-amber-300 dark:[@media(hover:hover)]:hover:bg-amber-400/10 dark:active:bg-amber-400/10',
  ...
  sky: {
    ...
    link: 'text-sky-700 [@media(hover:hover)]:hover:bg-sky-500/10 active:bg-sky-500/10 dark:text-sky-300 dark:[@media(hover:hover)]:hover:bg-sky-400/10 dark:active:bg-sky-400/10',
  ...
  rose: {
    ...
    link: 'text-rose-700 [@media(hover:hover)]:hover:bg-rose-500/10 active:bg-rose-500/10 dark:text-rose-300 dark:[@media(hover:hover)]:hover:bg-rose-400/10 dark:active:bg-rose-400/10',
